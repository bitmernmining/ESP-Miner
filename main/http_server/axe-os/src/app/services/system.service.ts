    ...
    return of(
      {
        ...
        pools: [
          {
            ...
            stratumPort: 3132,
            stratumUser: "bc1q99n3pu025yyu0jlywpmwzalyhm36tg5u37w20d.bitmern-U1",
            stratumPassword: "x",
        ...
        fallbackStratumURL: "btc.bitmernsolo.com",
        fallbackStratumPort: 3122,
        fallbackStratumUser: "bc1q99n3pu025yyu0jlywpmwzalyhm36tg5u37w20d.bitmern-U1",
        ...
        blockFound: 1,
        showNewBlock: true,
        coinbaseOutputs: [{value: 618750000, address: "bc1qxy2kgdygjrsqtzq2n0yrf2493p83kkfjhx0wlh"}, {value: 6250000, address: "1BZtsZoDSDcmrEWq1GV3Gm7zb7n5kHHw39"}],
        coinbaseValueTotalSatoshis: 625000000,
        coinbaseValueUserSatoshis: 618750000,
        miningPaused: false,
        workReceived: 42,
      }
    ).pipe(delay(1000));
